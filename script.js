...
class BulldogBuilder {
    ...
    initializeFirebase() {
        const checkFirebase = () => {
            if (typeof window !== 'undefined' && typeof db !== 'undefined' && db !== null && window.location.protocol !== 'file:') {
    ...
    async syncToFirebase(type, data, deleteId = null) {
        ...
        try {
            ...
            await db.collection('bulldogBuilder').doc(this.syncId).set(syncData, { merge: true });
    ...
    async loadData() {
        ...
        if (this.firebaseEnabled && typeof db !== 'undefined') {
            try {
                const docSnapshot = await db.collection('bulldogBuilder').doc(this.syncId).get();
